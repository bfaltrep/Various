...
#pragma omp parallel for
    ...
    {
      int path_cpy[MAXE];
      memcpy(path_cpy, path,MAXE*sizeof(int));
...
void tsp_seq (int hops, int len, int *path)
{
 int i ;
 int me, dist ;
